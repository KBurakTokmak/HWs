...
void manualGraph(vector<Room*>& maze, int size)
{
	...
	*/
	...
	maze[0]->neighbors.push_back(maze[1]);
	maze[1]->neighbors.push_back(maze[0]);
	maze[1]->neighbors.push_back(maze[7]);
	maze[2]->neighbors.push_back(maze[13]);
	maze[2]->neighbors.push_back(maze[4]);
	maze[2]->neighbors.push_back(maze[21]);
	maze[3]->neighbors.push_back(maze[24]);
	maze[3]->neighbors.push_back(maze[23]);
	maze[3]->neighbors.push_back(maze[14]);
	maze[4]->neighbors.push_back(maze[2]);
	maze[4]->neighbors.push_back(maze[16]);
	maze[5]->neighbors.push_back(maze[23]);
	maze[5]->neighbors.push_back(maze[6]);
	maze[5]->neighbors.push_back(maze[22]);
	maze[5]->neighbors.push_back(maze[19]);
	maze[6]->neighbors.push_back(maze[5]);
	maze[6]->neighbors.push_back(maze[11]);
	maze[6]->neighbors.push_back(maze[16]);
	maze[7]->neighbors.push_back(maze[1]);
	maze[7]->neighbors.push_back(maze[13]);
	maze[8]->neighbors.push_back(maze[17]);
	maze[8]->neighbors.push_back(maze[11]);
	maze[8]->neighbors.push_back(maze[13]);
	maze[9]->neighbors.push_back(maze[14]);
	maze[9]->neighbors.push_back(maze[24]);
	maze[10]->neighbors.push_back(maze[18]);
	maze[11]->neighbors.push_back(maze[8]);
	maze[11]->neighbors.push_back(maze[6]);
	maze[12]->neighbors.push_back(maze[28]);
	maze[12]->neighbors.push_back(maze[26]);
	maze[13]->neighbors.push_back(maze[2]);
	maze[13]->neighbors.push_back(maze[26]);
	maze[13]->neighbors.push_back(maze[24]);
	maze[13]->neighbors.push_back(maze[8]);
	maze[13]->neighbors.push_back(maze[7]);
	maze[13]->neighbors.push_back(maze[27]);
	maze[14]->neighbors.push_back(maze[9]);
	maze[14]->neighbors.push_back(maze[19]);
	maze[14]->neighbors.push_back(maze[3]);
	maze[15]->neighbors.push_back(maze[26]);
	maze[15]->neighbors.push_back(maze[28]);
	maze[16]->neighbors.push_back(maze[25]);
	maze[16]->neighbors.push_back(maze[4]);
	maze[16]->neighbors.push_back(maze[6]);
	maze[17]->neighbors.push_back(maze[8]);
	maze[18]->neighbors.push_back(maze[10]);
	maze[18]->neighbors.push_back(maze[28]);
	maze[19]->neighbors.push_back(maze[14]);
	maze[19]->neighbors.push_back(maze[5]);
	maze[20]->neighbors.push_back(maze[21]);
	maze[21]->neighbors.push_back(maze[20]);
	maze[21]->neighbors.push_back(maze[29]);
	maze[21]->neighbors.push_back(maze[2]);
	maze[22]->neighbors.push_back(maze[5]);
	maze[23]->neighbors.push_back(maze[24]);
	maze[23]->neighbors.push_back(maze[5]);
	maze[23]->neighbors.push_back(maze[3]);
	maze[24]->neighbors.push_back(maze[23]);
	maze[24]->neighbors.push_back(maze[3]);
	maze[24]->neighbors.push_back(maze[13]);
	maze[24]->neighbors.push_back(maze[9]);
	maze[25]->neighbors.push_back(maze[16]);
	maze[26]->neighbors.push_back(maze[15]);
	maze[26]->neighbors.push_back(maze[13]);
	maze[26]->neighbors.push_back(maze[12]);
	maze[27]->neighbors.push_back(maze[13]);
	maze[28]->neighbors.push_back(maze[12]);
	maze[28]->neighbors.push_back(maze[18]);
	maze[28]->neighbors.push_back(maze[15]);
	maze[29]->neighbors.push_back(maze[21]);
	*/
}
